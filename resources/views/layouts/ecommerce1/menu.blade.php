  <!-- Mega menu -->
  @php
      $categories = \App\Category::orderBy('updated_at', 'desc')->limit(4)->get();
  @endphp
  <div class="container mt-3 pt-3">
    <nav class="navbar navbar-expand-lg navbar-dark primary-color mt-5">
      <a class="font-weight-bold white-text mr-4" href="#"><i class="fas fa-filter"></i> FIltros</a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent1">
        ...
        <ul class="navbar-nav mr-auto">
          @foreach ($categories as $item)
            @php
              $subcategories = \App\SubCategory::where('category_id', $item->id)->orderBy('id', 'desc')->limit(6)->get();
            @endphp
