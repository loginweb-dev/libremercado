        ...
        <div class="col-md-12">
            <div class="panel panel-bordered">
                <div class="panel-body">
                    ...
                    <form method="post" id="search_form" class="form-search" action="#">
                        {{ csrf_field() }}
                        <div id="search-input">
                            ...
                            <div class="input-group col-md-9">
                                <input type="text" class="form-control"
                                    placeholder="{{ __('voyager::generic.search') }}" name="search_text"
                                    id="search_text" value="@if(isset($search_text)){{ $search_text }}@endif">
                            ...
                            <tbody>
                                ...
                                <tr id="{{ $data->id }}">
                                    ...
                                    <td class="no-sort no-click bread-actions">
                                        ...
                                        <a href="#"
                                            onclick="ajax('{{ route('voyager.'.$dataType->name.'.destroy', $data->id) }}', 'delete')"
                                            title="Eliminar" class="btn btn-danger">
                                            <i class="voyager-trash"></i> <span
                                                class="hidden-xs hidden-sm">Eliminar</span>
                                        </a>
                                        @endcan
                                    </td>
                                </tr>
